...
import net.Luca.firstMod.loot.AddItemModifier;
import net.Luca.firstMod.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("pine_cone_from_leaves", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("blocks/spruce_leaves")).build(),
