package net.Luca.firstMod.compat;
...
import net.Luca.firstMod.recipe.GemPolishingRecipe;
import net.minecraft.network.chat.Component;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.world.item.ItemStack;

public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(FirstMod.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTERE = new ResourceLocation(FirstMod.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
    ...
    public GemPolishingCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTERE, 0, 0, 176, 85);
