package net.Luca.firstMod.entity.custom;

import net.Luca.firstMod.entity.ModEntities;
import net.Luca.firstMod.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setupAnimationStates(){
        ...
        if(this.isAttacking() && attackAnimationTimeout<=0){
            attackAnimationTimeout = 80; //lungezza in tick
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2,new TemptGoal(this,1.2D, Ingredient.of(Items.ACACIA_LEAVES),false));
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(Items.ACACIA_LEAVES);
    }
