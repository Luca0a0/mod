...
import net.Luca.firstMod.entity.animations.ModAnimetionDefinitions;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimetionDefinitions.RHINO_WALK,limbSwing,limbSwingAmount,2f,2.5f);
		this.animate(((RhinoEntity) entity).idleAnimationState, ModAnimetionDefinitions.RHINO_IDLE,ageInTicks, 1f);
		this.animate(((RhinoEntity) entity).attackAnimationState, ModAnimetionDefinitions.RHINO_ATTACK,ageInTicks, 1f);
	}
